...
const TimeInput = ({
    ...
    }, [styles, theme, setFinalStyles, setFinalTheme]);
    ...
    useEffect(() => {
        if (firstLaunch.current || !Boolean(debouncedTime)) {
            setValidTime(true);
            onTimeChange('', true);
            return;
        }
    ...
    return (
        <View style={finalStyles.componentContainer}>
            <View style={finalStyles.container}>
                <TextInput
                    ...
                    style={[
                        finalStyles.input,
                        {
                            backgroundColor: finalTheme.inputBackgroundColor,
                            borderColor: finalTheme.inputBorderColor,
                            color: finalTheme.inputTextColor,
                        },
                    ]}
                    value={time}
                />
                ...
                <View style={[finalStyles.toggle, { backgroundColor: finalTheme.toggleBackgroundColor }]}>
                    <Touchable
                        ...
                        style={[finalStyles.toggleButton, { backgroundColor: finalTheme.toggleButtonBackground }]}
                    >
                        <Text style={{ color: finalTheme.toggleButtonTextColor }}>AM</Text>
                    </Touchable>
                    ...
                    <Touchable
                        ...
                        style={[finalStyles.toggleButton, { backgroundColor: finalTheme.toggleButtonBackground }]}
                    >
                        <Text style={{ color: finalTheme.toggleButtonTextColor }}>PM</Text>
                    </Touchable>
            ...
            {!validTime && (
                <Text style={{ marginTop: 10, color: finalTheme.errorTextColor }}>
                    {Boolean(errorText) && typeof errorText == 'string' ? errorText : 'Entered time is invalid.'}
                </Text>
            )}
        </View>
    );
